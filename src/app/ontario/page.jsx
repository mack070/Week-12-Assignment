export default function Ontario() {
  return (
    <div>
      ...
      <h1>Ontario Holiday Information</h1>
      <h2>
        <p>
          Welcome to Canada&apos;s Diverse Province and feel free to Explore
          Ontario&apos;s stunning landscapes, from the thundering Niagara Falls
          to the tranquil lakes of Muskoka. Embrace the diversity of experiences
          in Canada&apos;s most populated province.
        </p>

        <p>
          Day 1: Toronto&apos;s Towering Sights Begin in Toronto with a visit to
          the CN Tower, enjoying the urban panorama. Wander through the
          Distillery District and experience the city&apos;s vibrant arts scene.
        </p>

        <p>
          Day 2: Next travel to Niagara Falls and feel the mist of the mighty
          cascades. Take a boat tour to get up close to the stunningly beautiful
          falls, and visit the charming town of Niagara-on-the-Lake for an
          unforgettable experience like no other.
        </p>

        <p>
          Day 3: Find cultural connections when you Head to Ottawa,
          Canada&apos;s capital, to explore Parliament Hill and the national
          museums. Learn about Canada&apos;s history and cultural heritage.
        </p>

        <p>
          Day 4: Join our natural escapes retreat in Algonquin Provincial Park
          for a day of hiking, wildlife spotting, and canoeing in pristine
          wilderness.
        </p>

        <p>
          Day 5: Experience the cottage country and relax in Muskoka, known for
          its idyllic cottages and clear lakes. Then round up your trip with a
          peaceful sunset cruise, giving you time to reflect on the beauty of
          Ontario.
        </p>

        <p>
          You'll find each destination offers its own unique blend of
          experiences, ensuring that your holiday will be filled with cherished
          memories. So make sure to book your dream getaway today and let the
          adventure begin!
        </p>
      </h2>
