export default function NewYork() {
	return (
		<div>
			...
			<div className='bg-rose-200 p-4'>
				...
				<h2>
					<ul className='space-x-5 p-2'>
						...
						<br></br>
						<li>
							<b>Day 2: </b> Exploring Landmarks Stroll down Fifth Avenue, home
							to world-renowned shopping, and make your way to the historic
							Rockefeller Center. Ascend to the Top of the Rock Observation Deck
							for breathtaking panoramic views. As dusk falls, witness the city
							light up from the heights of the Empire State Building.
						</li>
						<br></br>
						<li>
							<b>Day 3: </b> Arts and Culture Delve into the rich tapestry of
							New York’s cultural scene with visits to the Metropolitan Museum
							of Art and the Museum of Modern Art. In the evening, enjoy a
							Broadway show, where the magic of theatre comes to life.
						</li>
						<br></br>
						<li>
							<b>Day 4: </b> A Walk in the Park Spend a leisurely day exploring
							Central Park. Row a boat on the lake, visit the Central Park Zoo,
							or simply picnic on the Great Lawn, surrounded by the park’s
							natural beauty.
						</li>
						<br></br>
						<li>
							<b>Day 5: </b> The Taste of New York Embark on a culinary journey
							through the diverse neighbourhoods of New York. Savour a classic
							New York bagel, indulge in a slice of authentic New York pizza,
							and dine at a Michelin-starred restaurant.
						</li>
						<br></br>
						<li>
							<b>Day 6: </b> Departure As your trip comes to a close, take a
							piece of New York with you. Whether it’s a souvenir from Times
							Square or memories of the city’s infectious energy, you’ll depart
			...
			<div className='bg-rose-200 p-4'>
				<h1 className='font-bold p-1 text-center text-xl'>
					New York City, often called the “Big Apple,” is a vibrant and iconic
				...
				<h2>
					<ul className='space-x-5 p-2'>
						<br></br>
						<li>
							<b>Subway System:</b> CThe NYC subway system is the largest in the
							world, with 472 stations connecting all five boroughs.
						</li>
						<br></br>
						<li>
							<b>New York Public Library:</b> The New York Public Library houses
							over 50 million books and is a treasure trove of knowledge.
						</li>
						<br></br>
						<li>
						...
						<br></br>
						<li>
							<b>Central Park Mall:</b> The only straight path in Central Park,
							lined with beautiful elm trees.
						</li>
						<br></br>
						<li>
						...
						<br></br>
						<li>
							<b>Frozen Harbor:</b> Believe it or not, the New York Harbor once
							completely froze over.
						</li>
						<br></br>
						<li>
							<b>Pizza Principle:</b> There’s a quirky correlation between
					...
					<p className='space-x-5 text-pretty text-center font-bold text-l p-2'>
						...
						excitement—perfect for your holiday advert! 🗽🌆🎉
					</p>
				</h2>
			</div>
			<div className='image-section-two grid grid-cols-3 gap-4 p-4'>
